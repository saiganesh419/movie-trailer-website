...
Deadpool = media.Movie("Deadpoll 2", "action",
                       "https://preview.ibb.co/cOeLvo/deadpool_2_movie_post"
                       "er.jpg",
                       "https://www.youtube.com/watch?v=wLeGWcVeIZ4")
Black = media.Movie("Black Panther", "action",
                    "https://image.ibb.co/iFHjMT/black_panther_poster_sfkn"
                    "_640.jpg",
                    "https://www.youtube.com/watch?v=xjDjIWPwcPU")
Ant = media.Movie("Ant Man and Wasp", "action",
                  "https://preview.ibb.co/m8L4MT/Ant_Man_and_The_Wasp_pos"
                  "ter_2.jpg",
